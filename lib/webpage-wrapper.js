...
class Page {
   ...
   * @param {string='png'} format   If format is not specified, the file extension
   *                                is extracted and used as the format.
   * @param {number=100}   quality  String or number value between 0 and 100
   */
   ...
   * is deleted after it is completed or done.
   */
  renderPdf() {
    this.throwIfClosed();
